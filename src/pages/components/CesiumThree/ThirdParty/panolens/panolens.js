...
GSVPANO.PanoLoader = function (parameters) {
     ...
     * @type {String}
     */
    PANOLENS.DataImageSource = 'textures/icons/';
...
PANOLENS.StereographicShader = {
	...
	*/
	...
	PANOLENS.Widget.prototype.addControlBar = function () {
		...
		gradientStyle = 'linear-gradient(top, rgba(0,0,0,0.2), rgba(0,0,0,0))';
	...
	PANOLENS.Widget.prototype.createCustomItem = function ( options ) {
		...
		item.style.pointerEvents = 'auto';
		// item.style.right = '-44px';
		// item.style.bottom = '34px';
	...
	PANOLENS.Viewer = function ( options ) {
		...
		options = options || {};
		options.controlBar = options.controlBar !== undefined ? options.controlBar : false;
		options.controlButtons = options.controlButtons || [ 'fullscreen', 'setting', 'video' ];
		options.autoHideControlBar = options.autoHideControlBar !== undefined ? options.autoHideControlBar : false;
		options.autoHideInfospot = options.autoHideInfospot !== undefined ? options.autoHideInfospot : false;
		options.horizontalView = options.horizontalView !== undefined ? options.horizontalView : false;
		options.clickTolerance = options.clickTolerance || 10;
		options.cameraFov = options.cameraFov || 90;
